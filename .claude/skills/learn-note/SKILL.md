...
1. 在 `~/.local/share/auto/learning/knowledge-map.yaml` 中查找概念
...
使用 `modules/learning/lib/templates/knowledge-note.md` 模板，创建/更新笔记：
...
1. 更新 `~/.local/share/auto/learning/knowledge-map.yaml` 中该概念的 `vault_notes` 字段
2. 确认笔记路径已添加
